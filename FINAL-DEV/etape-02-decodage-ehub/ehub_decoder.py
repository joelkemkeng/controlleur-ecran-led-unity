...
if __name__ == "__main__":
    print("🧪 [TEST] Test du décodeur eHub intégré")
    ...
    if decoder.initialize():
        print("✅ [TEST] Décodeur initialisé avec succès")
        
        # Écoute et décodage (limité pour test)
        print("🔄 [TEST] Démarrage écoute (10 paquets max)...")
        decoder.listen_and_decode(packet_limit=10)
    else:
        print("❌ [TEST] Échec initialisation décodeur")
